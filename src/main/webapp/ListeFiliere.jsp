...
<section>
	<div class="row">
		<div class="container">
			<h3 class="text-center">Liste Filières</h3>
			<hr>
			<form class="form-inline d-flex justify-content-center md-form form-sm mt-0" action="searchF" method="GET">
			...
			<table class="table table-bordered">
				...
				<c:if test="${not empty filieres}">
					<c:forEach var="fileire" items="${filieres}">
					    <tr>
					        <td>${fileire.id}</td>
					        <td>${fileire.nom}</td>
					        <c:forEach var="departement" items="${departements}">
					            <c:if test="${departement.id eq fileire.departementId}">
