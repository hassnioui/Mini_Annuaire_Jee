...
<body>
    <header id="header">
        <a href="href="<%=request.getContextPath()%>/index" class="logo">Mini Annuaire</a>
                                    ...
                                    <c:if test="${not empty successMessage}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="Nom" type="text" name="nom" class="form-control" placeholder="Veuillez entrer le Nom de filière" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
									        <div class="form-group">
									            <label for="departementId">Département</label>
									            <select name="departementId" class="form-control" required="required">
