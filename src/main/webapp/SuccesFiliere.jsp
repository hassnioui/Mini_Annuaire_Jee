                            ...
                            <form action="insertD" method="post">
                                <div class="controls">
										...
										<c:if test="${empty successMessage}">
										    <div class="col-md-12">
										        <div class="alert alert-danger" role="alert">
										            <strong>Erreur!</strong> Filière n'est pas ajouté avec succès !
										        </div>
										    </div>
										</c:if>
                                    </div>
                                    <div class="row">
                                    	...
                                    	<div class="col-md-6 mt-3">
                                            <a href="<%=request.getContextPath()%>/newF" class="btn btn-primary btn-send pt-2 btn-block" >Insérer Nouveau</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
